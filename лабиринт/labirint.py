...
#метод, в котором реализовано управление спрайтом по кнопкам стрелочкам клавиатуры
    ...
    def fire(self):
        bullet = Bullet('puli.png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w1 = GameSprite('horizontal_line1600.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('vertical_line1600.png', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('packman_blue.png', 5, win_height - 80, 80, 80, 0, 0)
enemy1 = Enemy('vrag.png', win_width - 100, 200, 80, 80, 4)
enemy2 = Enemy('vrag.png', win_width - 100, 100, 80, 80, 3)
#добавляем врагов в группу
enemys.add(enemy1)
enemys.add(enemy2)
 
final_sprite = GameSprite('packman.png', win_width - 100, win_height - 80, 80, 80)
...
#    w2.reset()
    ...
    if sprite.collide_rect(packman, final_sprite):
        finish = True
        img = image.load('last_thumb1447964390.jpg')
        window.fill((255, 255, 255))
